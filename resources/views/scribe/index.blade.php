...
<head>
    ...
    <title>Barbearia API Documentation</title>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;The nome field must be a valid JSON string. (and 3 more errors)&quot;,
    &quot;errors&quot;: {
        &quot;nome&quot;: [
            &quot;The nome field must be a valid JSON string.&quot;
        ],
        &quot;telefone&quot;: [
            &quot;The telefone field must be a valid JSON string.&quot;,
            &quot;The telefone field format is invalid.&quot;
        ],
        &quot;email&quot;: [
            &quot;The email field must be a valid JSON string.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="nome"                data-endpoint="GETapi-cliente"
               value="b"
               data-component="body">
    <br>
<p>Must be a valid JSON string. Must not be greater than 40 characters. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="telefone"                data-endpoint="GETapi-cliente"
               value="n"
               data-component="body">
    <br>
<p>Must be a valid JSON string. Must match the regex /^(?\d{2})?\s?\d{4,5}-?\d{4}$/. Must not be greater than 15 characters. Example: <code>n</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="GETapi-cliente"
               value="ashly64@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must be a valid JSON string. Must not be greater than 35 characters. Example: <code>ashly64@example.com</code></p>
        </div>
        </form>
