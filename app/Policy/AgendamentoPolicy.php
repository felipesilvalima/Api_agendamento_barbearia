...
class AgendamentoPolicy
{
   ...
   {
        return ($user->role === 'cliente' && $user->cliente->id === $agendamento->id_cliente)
        ? Response::allow() 
    ...
    {
        return ($user->role === 'cliente' && $user->cliente->id === $agendamento->id_cliente || $user->role === 'barbeiro' && $user->barbeiro->id === $agendamento->id_barbeiro)
        ? Response::allow() 
    ...
    {
        return  ($user->role === 'barbeiro' && $user->barbeiro->id === $agendamento->id_barbeiro) 
        ? Response::allow() 
